...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Первый месяц после запуска — бесплатно: правим опечатки, меняем цены, чиним всё, что всплывёт. Дальше — почасово или небольшим ежемесячным пакетом, зависит от того, как часто нужно обновлять контент.',
  },
  {
    q: 'Кто делает тексты и фотографии?',
    a: 'Фотографии — с вашей стороны, это критично: стоковые картинки еды видно сразу, и они снижают доверие. Тексты можем написать по вашим тезисам. В демо стоят стоковые фото — в реальном проекте на их место встают ваши снимки.',
  },
  {
    q: 'Что с хостингом и доменом?',
    a: 'Статический сайт бесплатно живёт на Vercel или Netlify — платить нужно только за домен, это примерно 200–1500 ₽ в год в зависимости от зоны. Настройку берём на себя, аккаунты регистрируем на вас, чтобы доступы остались у вас.',
  },
  {
    q: 'А если мне не понравится результат?',
    a: 'Работаем поэтапно. После прототипа вы видите живой сайт и решаете, идём дальше или нет. Если на этом этапе не нравится — расходимся, предоплата за прототип остаётся у нас, остальное не платите.',
  },
]
...
const CONTACTS = [
  ...
  { icon: Clock, label: 'Отвечаем', value: 'Пн–Пт, 10:00–20:00 МСК', href: undefined },
]
      ...
      >
        <div className="rounded-card border border-line bg-surface-2 p-8 text-center sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-md text-[15px] leading-relaxed text-ink-soft">
            {name}, спасибо. Ответим в течение рабочего дня и пришлём несколько уточняющих вопросов
            по проекту «{topic}».
          </p>
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-[13px] text-ink-soft">
            Компании, товары и контакты в демо-шаблонах вымышленные.
            <br />
            Фотографии — Unsplash.
          </p>
        </div>
