...
Снимки загружены с [Unsplash](https://unsplash.com) скриптом `scripts/fetch-photos.mjs`.
Лицензия Unsplash разрешает коммерческое использование и не требует указания авторства —
но авторы перечислены ниже, потому что это правильно.

Для реального клиентского проекта фотографии берутся у заказчика: стоковые снимки еды
узнаются с первого взгляда и снижают доверие к сайту.
...
| `g-terrace.webp` | [Yucel M](https://unsplash.com/@ymoran) |
| `hot-gyoza.webp` | [charlesdeluvio](https://unsplash.com/@charlesdeluvio) |
| `hot-miso.webp` | [Seiya Maeda](https://unsplash.com/@seiya_maeda) |
| `hot-ramen.webp` | [Cody  Chan](https://unsplash.com/@cceee) |
...
| `mn-vegetables.webp` | [Sam Moghadam](https://unsplash.com/@sammoghadam) |
...
| `roll-philadelphia.webp` | [Mahmoud Fawzy](https://unsplash.com/@mahmoud_fawzy100) |
| `roll-spicy-tuna.webp` | [Mahmoud Fawzy](https://unsplash.com/@mahmoud_fawzy100) |
| `set-osaka.webp` | [Mahmoud Fawzy](https://unsplash.com/@mahmoud_fawzy100) |
| `set-tokyo.webp` | [Riccardo Bergamini](https://unsplash.com/@deram31) |
| `set-veg.webp` | [Ömer Taha Çetin](https://unsplash.com/@omertahacetin) |
| `sf-bear.webp` | [Sandy Millar](https://unsplash.com/@sandym10) |
| `sf-fox.webp` | [Brunxs](https://unsplash.com/@brunxs) |
| `sf-whale.webp` | [Trevor Vannoy](https://unsplash.com/@tvannoy) |
| `st-burrata.webp` | [Delightin Dee](https://unsplash.com/@delightindee) |
